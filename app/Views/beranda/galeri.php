...
<div
	class="modal fade"
	id="searchModal<?= $kat['id'] ?>"
	tabindex="-1"
	aria-labelledby="exampleModalLabel"
	aria-modal="true"
	role="dialog">
	<div class="modal-dialog modal-lg">
		<!-- Mengganti ukuran modal -->
