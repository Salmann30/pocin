			...
			<div class="collapse navbar-collapse bg-white rounded fw-bold" id="navbarCollapse">
				...
				<div class="d-flex m-3 justify-content-between rounded">
					<div class="position-relative me-1">
						<form action="<?= base_url('produk') ?>" method="GET">
							<input
								type="search"
								name="keyword"
								class="form-control border-2 border-primary rounded-pill"
								placeholder="Cari Produk & UMKM"
								aria-describedby="search-icon-1" />
							<button
								type="submit"
								class="btn btn-primary border border-primary py-3 px-4 btn-search position-absolute rounded-pill text-white d-flex align-items-center justify-content-center"
					...
					<div class="d-flex align-items-center gap-2">
						<a
							href="<?= base_url('/login') ?>"
							class="btn border border-primary text-primary rounded-pill px-3 btn-login">
							Login
						</a>
					</div>
				</div>
