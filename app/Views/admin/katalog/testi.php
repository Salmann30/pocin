		...
		<div class="col-lg-10 col-sm-12">
			...
			<div class="card shadow">
				<div
					...
					<b
						>Testimoni Produk <u><?= $produk['nama_produk'] ?></u></b
					>
					<button
								...
								<tr>
									...
									<td>
										<a
											...
											data-bs-toggle="modal"
											data-bs-target="#editTestiModal<?= $t->id_testi ?>">
...
<div class="modal fade" id="editTestiModal<?= $t->id_testi ?>" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog">
		<form
			action="/admin/produk/testiupdate/<?= $t->id_testi ?>"
			method="post"
			class="modal-content">
			<?= csrf_field() ?>
...
<div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog">
		<form
			action="/admin/produk/testiadd/<?= $produk['id_produk'] ?>"
			method="post"
			class="modal-content">
			<?= csrf_field() ?>
			<div class="modal-header">
